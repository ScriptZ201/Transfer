...
.setTimestamp()
 message.channel.send(robloxEmbed) //Send the first Embed
...
.setTimestamp()
 message.channel.send(foundUsername) //The part where it asks you to add the Code
...
.setFooter("Fetching..")
.setTimestamp()
         message.channel.send(fetchingBlurb) //Checks the Blurb / Status
...
.setFooter("Verifying..")
.setTimestamp() 
               message.channel.send(verified) // Sent if user has put code
